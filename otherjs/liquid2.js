const LiquidButton = class LiquidButton {
	constructor(optionsParam) {
		...
		this.text = options.text || 'Посетить виртуальный музей';
	...
	draw() {
		...
		this.context.font = '100 ' + (this.height - this.padding * 2) + 'px "Russo One", sans-serif';
...
gui.add(button, "width", 500, 500, 1).onchange(redraw);
